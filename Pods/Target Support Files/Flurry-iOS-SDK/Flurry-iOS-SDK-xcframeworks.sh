...
variant_for_slice()
{
  ...
  "CrashReporter.xcframework/ios-arm64_arm64e_armv7_armv7s")
    echo ""
    ;;
  "Flurry_Messaging.xcframework/tvos-arm64_x86_64-simulator")
    echo "simulator"
    ;;
  "Flurry_Messaging.xcframework/ios-arm64_i386_x86_64-simulator")
    echo "simulator"
    ;;
  "Flurry_Messaging.xcframework/tvos-arm64")
    echo ""
    ;;
  "Flurry_Messaging.xcframework/ios-arm64_armv7")
    echo ""
    ;;
...
install_xcframework "${PODS_ROOT}/Flurry-iOS-SDK/Flurry_Messaging.xcframework" "Flurry-iOS-SDK/FlurryMessaging" "framework" "ios-arm64_i386_x86_64-simulator" "ios-arm64_armv7"
